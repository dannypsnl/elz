...
@.str = private unnamed_addr constant [22 x i8] c"Our Global value: %f\0A\00", align 1

; Function Attrs: noinline nounwind optnone uwtable
define i32 @main() #0 {
entry:
  %call = call double (...) @nestedinstruction()
  %call1 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([22 x i8], [22 x i8]* @.str, i32 0, i32 0), double %call)
  ret i32 0
}
