...
var parserATN = []uint16{
	...
	380, 3, 2, 2, 2, 380, 381, 7, 53, 2, 2, 381, 382, 7, 31, 2, 2, 382, 383,
	5, 36, 19, 2, 383, 73, 3, 2, 2, 2, 384, 386, 7, 36, 2, 2, 385, 387, 5,
	50, 26, 2, 386, 385, 3, 2, 2, 2, 386, 387, 3, 2, 2, 2, 387, 388, 3, 2,
	2, 2, 388, 389, 7, 53, 2, 2, 389, 391, 7, 12, 2, 2, 390, 392, 5, 70, 36,
	...
	2, 2, 399, 77, 3, 2, 2, 2, 400, 401, 7, 53, 2, 2, 401, 403, 7, 12, 2, 2,
	...
	2, 412, 413, 3, 2, 2, 2, 413, 414, 7, 37, 2, 2, 414, 415, 7, 53, 2, 2,
	...
	2, 433, 434, 7, 27, 2, 2, 434, 435, 7, 55, 2, 2, 435, 436, 7, 11, 2, 2,
	436, 453, 3, 2, 2, 2, 437, 438, 7, 10, 2, 2, 438, 439, 5, 32, 17, 2, 439,
	440, 7, 11, 2, 2, 440, 453, 3, 2, 2, 2, 441, 453, 7, 56, 2, 2, 442, 444,
	7, 55, 2, 2, 443, 445, 5, 2, 2, 2, 444, 443, 3, 2, 2, 2, 444, 445, 3, 2,
	2, 2, 445, 453, 3, 2, 2, 2, 446, 448, 7, 54, 2, 2, 447, 449, 5, 4, 3, 2,
	448, 447, 3, 2, 2, 2, 448, 449, 3, 2, 2, 2, 449, 453, 3, 2, 2, 2, 450,
	453, 7, 53, 2, 2, 451, 453, 7, 57, 2, 2, 452, 421, 3, 2, 2, 2, 452, 424,
	...
	55, 2, 2, 484, 489, 7, 11, 2, 2, 485, 486, 12, 20, 2, 2, 486, 487, 7, 40,
...
func (p *ElzParser) FnCall() (localctx IFnCallContext) {
	...
	if (((_la)&-(0x1f+1)) == 0 && ((1<<uint(_la))&((1<<ElzParserT__7)|(1<<ElzParserT__9)|(1<<ElzParserT__18))) != 0) || (((_la-36)&-(0x1f+1)) == 0 && ((1<<uint((_la-36)))&((1<<(ElzParserT__35-36))|(1<<(ElzParserT__36-36))|(1<<(ElzParserID-36))|(1<<(ElzParserFLOAT-36))|(1<<(ElzParserINT-36))|(1<<(ElzParserBOOLEAN-36))|(1<<(ElzParserSTRING-36)))) != 0) {
		{
			p.SetState(206)
			p.ExprList()
		}
